...
form_schema = StructType([
    ...
    StructField("expiryDate", StructType([StructField("$date", TimestampType())])),
    ...
    StructField("createdAt", StructType([StructField("$date", TimestampType())])),
    ...
    StructField("googleSheet", StringType(), True),
    ...
    StructField("modifiedAt", StructType([StructField("$date", TimestampType())])),
...
weightage_schema = StructType([
    StructField("question_id", StringType(), True),
    StructField("weightage_json", StringType(), True)  
])
